...
namespace VCRSharp
{
    ...
    {
        public static async Task<CachedRequest> Serialize(HttpRequestMessage request)
        {
        ...
        public static HttpRequestMessage Deserialize(CachedRequest cachedRequest)
        {
        ...
        public static async Task<CachedResponse> Serialize(HttpResponseMessage freshResponse)
        {
        ...
        public static HttpResponseMessage Deserialize(CachedResponse cachedResponse)
        {
